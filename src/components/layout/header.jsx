...
export const Header = ({ }) => {
  ...
  return <>
    <header className="z-100 flex w-full h-fit justify-center items-center fixed bottom-0 md:top-0 pr-2 pl-2 pb-[50px] md:pt-[30px] ">
      ...
      >
        <PrimaryButton className={className} text={"Home"} handleClick={()=>ScrollTo("#Home")}></PrimaryButton>
        <PrimaryButton className={className} text={"About"}  handleClick={()=>ScrollTo("#About")}></PrimaryButton>
        <PrimaryButton className={className} text={"Skills"} handleClick={()=>ScrollTo("#Skills")}></PrimaryButton>
        <PrimaryButton className={className} text={"Projects"} handleClick={()=>ScrollTo("#Projects")}></PrimaryButton>
        <PrimaryButton className={className} text={"Contact"} handleClick={()=>ScrollTo("#Contact")}></PrimaryButton>
        ...
        <ToggleButton className={" md:hidden max-w-[50px] max-h-[50px] min-w-[50px] min-h-[50px] p-2.5"} handleClick={(v)=>{v?ScrollTo("#Home"):ScrollTo("#Contact")}} icon1={<ArrowLogo className={classNameIcon} />} icon2={<ArrowLogo className={classNameIcon+" rotate-180"}  />} ></ToggleButton>
